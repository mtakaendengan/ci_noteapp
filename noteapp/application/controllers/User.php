...

{
...

    {
        ...
        $data['act'] = $this->db->get_where('user_active', ['id_active' => $this->session->userdata('ac_user')])->row_array();

        $data['role'] = $this->db->get_where('user_role', ['id_role' => $this->session->userdata('lv_user')])->row_array();

        $data['sub'] = $this->db->get_where('user_sub_role', ['id_sub_role' => $this->session->userdata('sb_user')])->row_array();
