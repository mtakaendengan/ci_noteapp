...
class Menu extends CI_Controller
{
    ...
    public function deleteSubMenu($id_sub)
    {
        $this->Menu_model->deleteSubData($id_sub);
        $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Sub Menu Removed</div>');
        redirect('menu/submenu/');
    }
}
